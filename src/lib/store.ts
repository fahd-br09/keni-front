...
const DEFAULT_NEWS: NewsItem[] = [
  ...
  { _id: '2', titleAr: 'الجماعة تطلق منصة رقمية لتتبع الطلبات الإدارية', contentAr: 'في إطار مسيرة التحول الرقمي، أطلقت بلدية القنيطرة منصة إلكترونية متكاملة تتيح للمواطنين تتبع طلباتهم الإدارية في الوقت الفعلي.', image: 'http://www.kenitra.ma/assets/images/articles/news-177-imgp-20260422-120400.png', category: 'رقمنة', createdAt: '2026-04-08T09:00:00Z' },
  { _id: '3', titleAr: 'حملة نظافة شاملة في أحياء المدينة', contentAr: 'نظمت الجماعة حملة نظافة واسعة النطاق شملت جميع أحياء المدينة بمشاركة المواطنين والجمعيات المدنية والسلطات المحلية.', image: 'http://www.kenitra.ma/assets/images/articles/news-168-imgp-20260317-030302.jpg', category: 'بيئة', createdAt: '2026-04-05T08:00:00Z' },
  { _id: '4', titleAr: 'افتتاح حديقة عمومية جديدة بحي المسيرة', contentAr: 'افتتحت بلدية القنيطرة حديقة عمومية جديدة بحي المسيرة تضم مساحات خضراء وملاعب للأطفال ومرافق للراحة والترفيه.', image: 'http://www.kenitra.ma/assets/images/articles/news-176-imgp-20260422-120423.png', category: 'تهيئة', createdAt: '2026-04-02T11:00:00Z' },
  { _id: '5', titleAr: 'إعلان عن مباراة توظيف بالجماعة الحضرية', contentAr: 'تعلن الجماعة الحضرية للقنيطرة عن فتح باب الترشيح لمباراة توظيف في عدة تخصصات إدارية وتقنية. آخر أجل للتقديم 30 أبريل 2026.', image: 'http://www.kenitra.ma/assets/images/articles/news-175-imgp-20260422-120412.png', category: 'إعلانات', createdAt: '2026-03-28T10:00:00Z' },
  { _id: '6', titleAr: 'اجتماع المجلس الجماعي يصادق على ميزانية 2026', contentAr: 'صادق المجلس الجماعي للقنيطرة في دورته العادية على ميزانية السنة المالية 2026 البالغة 320 مليون درهم.', image: 'http://www.kenitra.ma/assets/images/articles/news-171-imgp-20260403-120423.jpg', category: 'مجلس', createdAt: '2026-03-20T14:00:00Z' },
];
...
const DEFAULT_SERVICES: Service[] = [
  ...
  { _id: '4', titleAr: 'الشكاوى والمقترحات', descriptionAr: 'تقديم شكاوى أو مقترحات لتحسين الخدمات الجماعة', category: 'التواصل', requiredDocuments: ['بطاقة التعريف الوطنية'] },
